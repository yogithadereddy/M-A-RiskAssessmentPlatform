...
def calculate_legal_risk_score(entities):
    """
    Calculates a legal risk score based on extracted named entities.
    Incorporates additional entities relevant to legal risk, such as fines and penalties.
    """
    risk_weights = {
        "ORG": 0.2,         # Organizations involved in the case
        "LAW": 0.4,         # Specific laws or regulations mentioned
        "MONEY": 0.4,       # Fines, penalties, or damages
        "DATE": 0.1,        # Dates related to legal actions
        "GPE": 0.2,         # Geopolitical locations (jurisdictions)
        "EVENT": 0.3,       # Major legal events (like lawsuits or settlements)
        "CARDINAL": 0.1,    # Numerical references, like amounts, case numbers, etc.
        "FINE": 0.5,        # Fines or penalties specifically extracted
        "PENALTY": 0.5,     # Penalties associated with legal violations
        "CRIME": 0.6,       # Crimes, allegations, or violations mentioned
        "CLAIM": 0.4        # Claims or accusations in legal contexts
    }
